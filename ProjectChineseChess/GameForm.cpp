...
inline ProjectChineseChess::GameForm::GameForm(void)
{
	InitializeComponent();
	gameform = this;
	//
...
inline ProjectChineseChess::GameForm::~GameForm()
{
	if (components)
	{
		delete components;
...
inline void ProjectChineseChess::GameForm::InitializeComponent(void)
{
...
inline System::Void ProjectChineseChess::GameForm::GameForm_FormClosing(System::Object^ sender, System::Windows::Forms::FormClosingEventArgs^ e)
{
	Application::Exit();
}
