...
inline ProjectChineseChess::StartForm::StartForm(void)
{
	InitializeComponent();
	startform = this;
	//
...
inline ProjectChineseChess::StartForm::~StartForm()
{
	if (components)
	{
		delete components;
...
inline void ProjectChineseChess::StartForm::InitializeComponent(void)
{
...
inline System::Void ProjectChineseChess::StartForm::button1_Click(System::Object^ sender, System::EventArgs^ e)
{
...
inline System::Void ProjectChineseChess::StartForm::button2_Click(System::Object^ sender, System::EventArgs^ e)
{
	Application::Exit();
}
